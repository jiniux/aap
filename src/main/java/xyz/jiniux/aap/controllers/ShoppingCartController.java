...
public class ShoppingCartController {
    ...
    public ResponseEntity<?> addItemToCart(Principal principal, @RequestBody @Valid AddItemShoppingCartRequest request) {
        ...
        return ResponseEntity.ok(new SyncShoppingCartResult(newItems, removedItems, priceChangedItems));
    }
    ...
    public ResponseEntity<?> getSyncedShoppingCart(Principal principal) {
        ...
        return ResponseEntity.ok(new SyncShoppingCartResult(items, removedItems, priceChangedItems));
    }
