...
@Getter
public class StockAlreadyNotOnSaleException extends RuntimeException {
    public StockAlreadyNotOnSaleException(String isbn, StockFormat stockFormat, StockQuality stockQuality) {
